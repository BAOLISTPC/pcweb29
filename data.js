/*
  足球数据 V5 — 以 2026-08-21 最新上传记录为唯一数据源
  ...
  - 2025：逐场进球合计 45，年度汇总写 43。
    原文年度汇总保留用于对照；V5 图表、月份总计与赛季交互数字统一按逐场比赛相加。
*/
...
window.SITE_DATA = {
  "profile": {
    ...
    "aboutText": "足球数据以最新上传记录为准。V5 按逐场比赛相加生成年度/月度数据，并通过二级比赛页面记录逐球信息与对应视频；原记录没有提供的时间不做推测。",
    "links": [
      {
        "label": "GitHub",
